...
export default function CompanyDetailScreen() {
  ...
  const listHeader = (
    <>
      ...
      <View style={[styles.section, { paddingHorizontal: s.xl, marginTop: s['2xl'], paddingBottom: s.md }]}>
  ...
  const renderVacancy = ({ item: vacancy }: { item: (typeof vacancies)[number] }) => (
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <FlatList
        data={vacanciesLoading ? [] : vacancies}
