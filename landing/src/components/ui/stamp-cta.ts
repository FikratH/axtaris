/**
 * The stamp-pad CTA treatment — the page's two conversion stamps (hero and
...
export const stampCtaClass =
  "inline-flex min-h-12 -rotate-[1.5deg] items-center justify-center gap-2 rounded-[6px] bg-carbon-600 px-7 font-[family-name:var(--font-display)] text-[1.125rem] font-bold tracking-[0.07em] text-cover-950 uppercase no-underline shadow-[inset_0_0_0_2px_var(--carbon-600),inset_0_0_0_3.5px_var(--cover-950),0_2px_0_0_var(--carbon-700)] transition-[background-color,rotate,transform] duration-150 hover:rotate-0 hover:bg-carbon-500";
